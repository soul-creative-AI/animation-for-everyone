...
const RESEARCH_FIRST = '리서치를 시작해볼게요! 먼저 하나만 알려주세요.\n이 작품은 처음부터 새로 만드는 오리지널인가요, 아니면 원작이 있는 각색 작품인가요?\n\n오리지널이라면 어떤 아이디어를 갖고 계신지 편하게 말씀해주세요!\n각색이라면 "OOO 리서치해줘"처럼 작품명과 함께 말씀해주시면 제가 웹에서 바로 찾아드려요.\n\n📎 관련 자료(기획서·리서치 문서·예전에 내보낸 파일 등)가 있다면 입력창 왼쪽 + 버튼으로 올리거나 끌어다 놓아주세요 — 내용을 읽어 빈 항목을 채워드려요. 원작 전체 파일은 "원작 아카이브" 탭에 올리면 화별 정리까지 함께 됩니다.';
const ARCHIVE_FIRST = '정리된 원작 아카이브를 근거로 답해드려요.\n"○○가 각성하는 장면 몇 화야?", "△△가 처음 나오는 화는?"처럼 물어보시면 해당 권/화를 찾아드릴게요.';

export { PLANNING_FIRST, RESEARCH_FIRST, ARCHIVE_FIRST };
